...
//        ]);
    ...
    public function destroy($id)
    {
        ...
        if ($isDelete) { // xóa thành công
           return response()->json(['success' =>1,'message' => 'thanh cong']);// {'isSuccess':1, 'message' : 'thanh cong'}
        } else {
            return response()->json(['success' =>0,'message' => 'that bai']);// {'isSuccess':1, 'message' : 'thanh cong'}

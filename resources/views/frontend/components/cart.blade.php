@if(count($cart) > 0)
    <section class="ftco-section ftco-cart mt-50">
                        ...
                        <table class="table list-cart">
                            ...
                            @foreach($cart as $item)
                                <tr class="text-center">
                                    ...
                                    <td class="image-prod">
                                        <img src="{{ asset($item->options->image) }}" width="75" height="50" alt="">
                                    </td>
                                    ...
                                    <td class="quantity">
                                        <div class="input-group mb-3">
                                            <input name="qty"style="
    width: 150px;
    padding-right: 5px;
    margin-right: 8px;
    margin-left: -58px;
" class="quantity form-control input-number d-block item-qty w-20 mr-7" value="{{ $item->qty }}" >
                                        </div>

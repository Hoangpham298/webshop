...
! function(t) {
...
}([function(t, e, i) { t.exports = i(14) }, , , , , , , , , , , , , , function(t, e, i) {
    (function(t) {
        "use strict";
        ...
        var n = i(15),
            o = e(n);
        i(16), i(18), i(19), i(20), i(21), i(22), i(23), i(24), i(92), i(93), i(96), i(97), i(98), i(100), i(101), i(102), i(104), i(105), i(106), i(107), i(108), i(109), i(110), i(111), i(112), i(113), i(114), i(115), i(116), i(117), i(118), i(120), i(121), i(122), jQuery(function() { return t.Flatsome.attach(document) }), t.cookie = o.default
     ...
     */
    ! function(r, s) { n = [i(17)], o = function(t) { return s(r, t) }.apply(e, n), !(void 0 !== o && (t.exports = o)) }(window, function(t, e) {
        "use strict";
    ...
    function(t, i) { n = [s, a, c, u, h, d], !(f = function(e, n, o, r, s, a) { return i(t, e, n, o, r, s, a) }.apply(e, n)) }(window, function(t, e, i, n, o, r, s) {
        ...
        function l(t, e) {
            ...
            if (this.element = i, this.element.flickityGUID) { var o = f[this.element.flickityGUID]; return o.option(e), o }
        ...
        return p.setCellAlign = function() {
            ...
            return o
        }, p.queryCell = function(t) { return "number" == typeof t ? this.cells[t] : ("string" == typeof t && (t = this.element.querySelector(t)), this.getCell(t)) }, p.uiChange = function() { this.emitEvent("uiChange") }, p.childUIPointerDown = function(t) { this.emitEvent("childUIPointerDown", [t]) }, p.onresize = function() { this.watchCSS(), this.resize() }, n.debounceMethod(l, "onresize", 150), p.resize = function() {
            if (this.isActive) {
     ...
     * MIT license
     */
    function(t, i) { n = [s], !(p = function(e) { return i(t, e) }.apply(e, n)) }(window, function(t, e) {
        function i() {}
     ...
     * MIT license
     */
    function(t, i) { n = [p], !(m = function(e) { return i(t, e) }.apply(e, n)) }(window, function(t, e) {
        function i() {}
    ...
    function(t, i) { n = [f, m, c], !(g = function(e, n, o) { return i(t, e, n, o) }.apply(e, n)) }(window, function(t, e, i, n) {
     ...
     * MIT license
     */
    function(t, i) { n = [p], !(v = function(e) { return i(t, e) }.apply(e, n)) }(window, function(t, e) {
    ...
    function(t, i) { n = [f, v, c], !(y = function(e, n, o) { return i(t, e, n, o) }.apply(e, n)) }(window, function(t, e, i, n) {
        "use strict";
    ...
    function(t, i) { n = [f, v, c], !(b = function(e, n, o) { return i(t, e, n, o) }.apply(e, n)) }(window, function(t, e, i, n) {
    ...
    function(t, i) { n = [s, c, f], !(w = function(t, e, n) { return i(t, e, n) }.apply(e, n)) }(window, function(t, e, i) {
    ...
    function(t, i) { n = [f, c], !(x = function(e, n) { return i(t, e, n) }.apply(e, n)) }(window, function(t, e, i) {
    ...
    function(t, i) { n = [f, c], !(S = function(e, n) { return i(t, e, n) }.apply(e, n)) }(window, function(t, e, i) {
        "use strict";
    ...
    ! function(s) {
        ...
        return n.defaults = { axis: "xy", duration: 0, limit: !0 }, t.fn.scrollTo = function(o, r, s) {
            ...
            return a && (r /= 2), s.offset = i(s.offset), s.over = i(s.over), this.each(function() {
                function l(e) {
                    var i = t.extend({}, s, { queue: !0, duration: r, complete: e && function() { e.call(h, f, s) } });
                    d.animate(p, i)
                }
                if (null !== o) {
                    var c, u = e(this),
    ...
    var n, o, r;
    ! function(s) { o = [i(17)], n = s, r = "function" == typeof n ? n.apply(e, o) : n, !(void 0 !== r && (t.exports = r)) }(function(t) {
        var e, i, n, o, r, s, a = "Close",
            ...
            w = !!window.jQuery,
            x = t(window),
            S = function(t, i) { e.ev.on(p + t + m, i) },
            ...
            k = function(i, n) { e.ev.triggerHandler(p + i, n), e.st.callbacks && (i = i.charAt(0).toLowerCase() + i.slice(1), e.st.callbacks[i] && e.st.callbacks[i].apply(e, t.isArray(n) ? n : [n])) },
        ...
        var j, I, P, A = "inline",
            O = function() { P && (I.after(P.addClass(j)).detach(), P = null) };
        ...
        t.magnificPopup.registerModule("gallery", {
            ...
            proto: {
                initGallery: function() {
                    ...
                    }), S(f + o, function() { e._preloadTimeout && clearTimeout(e._preloadTimeout), e._preloadTimeout = setTimeout(function() { e.preloadNearbyImages(), e._preloadTimeout = null }, 16) }), void S(a + o, function() { n.off(o), e.wrap.off("click" + o), e.arrowRight = e.arrowLeft = null }))
                },
    ...
    ! function(t, e, i) {
        ...
        n.prototype = {
                            ...
                            if (n.$tooltip = t('<div class="tooltipster-base ' + n.options.theme + '" style="' + u + " " + h + " " + d + " " + l + '"><div class="tooltipster-content"></div></div>'), s() && n.$tooltip.addClass(a), n._content_insert(), n.$tooltip.appendTo("body"), n.reposition(), n.options.functionReady.call(n.$el, n.$el, n.$tooltip), s() ? (n.$tooltip.addClass(a + "-show"), n.options.speed > 0 && n.$tooltip.delay(n.options.speed), n.$tooltip.queue(o)) : n.$tooltip.css("display", "none").fadeIn(n.options.speed, o), n._interval_set(), t(e).on("scroll." + n.namespace + " resize." + n.namespace, function() { n.reposition() }), n.options.autoClose)
                                if (t("body").off("." + n.namespace), "hover" == n.options.trigger) {
                                    if (c && setTimeout(function() { t("body").on("touchstart." + n.namespace, function() { n.hide() }) }, 0), n.options.interactive) {
                                        ...
                                        var f = null;
                                        n.$elProxy.add(n.$tooltip).on("mouseleave." + n.namespace + "-autoClose", function() { clearTimeout(f), f = setTimeout(function() { n.hide() }, n.options.interactiveTolerance) }).on("mouseenter." + n.namespace + "-autoClose", function() { clearTimeout(f) })
            ...
            reposition: function() {
                ...
                function n(i, n) { a.offset.top - t(e).scrollTop() - c - A - 12 < 0 && n.indexOf("top") > -1 && (L = i), a.offset.top + a.dimension.height + c + 12 + A > t(e).scrollTop() + t(e).height() && n.indexOf("bottom") > -1 && (L = i, P = a.offset.top - c - A - 12) }
                var o = this;
                if (0 !== t("body").find(o.$tooltip).length) {
                    ...
                    o.$tooltip.css({ top: Math.round(P) + "px", left: Math.round(j) + "px" })
                }
                return o
            },
    ...
    t.exports = function(t, e, i, y, b, w, x) {
        ...
        if (L && (k = h(L.call(new t)), k !== Object.prototype && k.next && (u(k, T, !0), n || a(k, d) || s(k, d, v))), _ && P && P.name !== g && (j = !0, A = function() { return P.call(this) }), n && !x || !f && !j && I[d] || s(I, d, A), l[e] = A, l[T] = v, b)
...
}, function(t, e) { t.exports = function(t) { return "object" == typeof t ? null !== t : "function" == typeof t } }, function(t, e, i) { t.exports = !i(44) && !i(45)(function() { return 7 != Object.defineProperty(i(46)("div"), "a", { get: function() { return 7 } }).a }) }, function(t, e, i) {
    t.exports = !i(45)(function() { return 7 != Object.defineProperty({}, "a", { get: function() { return 7 } }).a })
}, function(t, e) { t.exports = function(t) { try { return !!t() } catch (t) { return !0 } } }, function(t, e, i) {
    var n = i(42),
        o = i(35).document,
    ...
    var n = i(35),
        ...
        $ = r && c(function() { return 7 != S(j({}, "a", { get: function() { return j(this, "a", { value: 7 }).a } })).a }) ? function(t, e, i) {
            var n = _(W, e);
            n && delete W[e], j(t, e, i), n && t !== W && j(W, e, n)
        } : j,
        V = function(t) { var e = F[t] = S(P[L]); return e._k = t, e },
        q = B && "symbol" == typeof P.iterator ? function(t) { return "symbol" == typeof t } : function(t) { return t instanceof P },
        U = function(t, e, i) { return t === W && U(N, e, i), y(t), e = w(e, !0), y(i), o(F, e) ? (i.enumerable ? (o(t, D) && t[D][e] && (t[D][e] = !1), i = S(i, { enumerable: x(0, !1) })) : (o(t, D) || j(t, D, x(1, {})), t[D][e] = !0), $(t, e, i)) : j(t, e, i) },
        ...
        X = function(t) { var e = Q.call(this, t = w(t, !0)); return !(this === W && o(F, t) && !o(N, t)) && (!(e || !o(this, t) || !o(F, t) || o(this, D) && this[D][t]) || e) },
        K = function(t, e) { if (t = b(t), e = w(e, !0), t !== W || !o(F, e) || o(N, e)) { var i = _(t, e); return !i || !o(F, e) || o(t, D) && t[D][e] || (i.enumerable = !0), i } },
        Z = function(t) { for (var e, i = I(b(t)), n = [], r = 0; i.length > r;) o(F, e = i[r++]) || e == D || e == l || n.push(e); return n },
        J = function(t) { for (var e, i = t === W, n = I(i ? N : b(t)), r = [], s = 0; n.length > s;) !o(F, e = n[s++]) || i && !o(W, e) || r.push(F[e]); return r };
    B || (P = function() {
    ...
    }, a(P[L], "toString", function() { return this._k }), k.f = K, E.f = U, i(87).f = C.f = Z, i(84).f = X, i(83).f = J, r && !i(33) && a(W, "propertyIsEnumerable", X, !0), p.f = function(t) { return V(f(t)) }), s(s.G + s.W + s.F * !B, { Symbol: P });
    ...
    s(s.S + s.F * !B, "Symbol", {
        for: function(t) { return o(z, t += "") ? z[t] : z[t] = P(t) },
        keyFor: function(t) {
    ...
    var n = i(65)("meta"),
        ...
        f = function(t) { return c && p.NEED && l(t) && !r(t, n) && u(t), t },
        p = t.exports = { KEY: n, NEED: !1, fastKey: h, getWeak: d, onFreeze: f }
}, function(t, e, i) {
    var n = i(35),
        o = i(36),
        r = i(33),
    ...
    function a(t) {
        var e = o(t),
            i = t[h];
        if (e["object-fit"] = e["object-fit"] || "fill", !i.img) { if ("fill" === e["object-fit"]) return; if (!i.skipTest && p && !e["object-position"]) return }
    ...
    ! function(t, e) {
        ...
        }, n.prototype._rootIsInDom = function() { return !this.root || h(e, this.root) }, n.prototype._rootContainsTarget = function(t) { return h(this.root || e, t) }, n.prototype._registerInstance = function() { f.indexOf(this) < 0 && f.push(this) }, n.prototype._unregisterInstance = function() {
    ...
    function i(t) { t.classList.add("parallax-active"), !document.querySelector("body").classList.contains("parallax-mobile") && /Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent) || t.classList && t.dataset && (p.push({ element: t, type: a(t) }), o(p[p.length - 1])) }

    function n() { for (var t = 0; t < p.length; t++) p[t].element.offsetParent ? o(p[t]) : p.splice(t, 1) }
    ...
    Flatsome.behavior("tabs", {
        attach: function(t) {
            ...
            jQuery(".tabbed-content", t).each(function(t, o) {
                ...
                }), l.length && (e.toLowerCase().indexOf("comment-") >= 0 || "#comments" === e || "#reviews" === e || "#tab-reviews" === e ? (l.find("a").click(), jQuery.scrollTo(".reviews_tab", { duration: 300, offset: -150 })) : (n.indexOf("comment-page-") > 0 || n.indexOf("cpage=") > 0) && (l.find("a").click(), jQuery.scrollTo(".reviews_tab", { duration: 300, offset: -150 })))
            })
        }
    })
}, function(t, e) {
    ...
    Flatsome.behavior("toggle", {
        attach: function(t) {
            ...
            jQuery(".sidebar-menu li.menu-item.has-child", t).each(function() {
                var t = jQuery(this),
                    n = t.find("> a:first");
                "#" === n.attr("href") ? n.click(function(e) { e.preventDefault(), t.toggleClass("active"), t.attr("aria-expanded", "false" === t.attr("aria-expanded") ? "true" : "false") }) : i && n.next(".toggle").length && n.click(e)
            })
        }
    })
}, function(t, e) {
    ...
    function n(t) { t.attr("aria-hidden", "false"), t.find("> li > a, > li > button").attr("tabindex", "") }
        ...
        attach: function(t) {
            ...
            jQuery(".mobile-sidebar-slide", t).each(function(t, o) {
                ...
                jQuery(["> li > ul.children", "> li > .sub-menu", r > 1 ? "> li > ul.children > li > ul" : null].filter(Boolean).join(", "), a).each(function(t, o) {
                    ...
                    r.prepend(f), i(r);
                    var p = null;
                    c.off("click").click(function(t) { a.attr("aria-expanded", "true"), l.addClass("is-current-parent"), r.addClass("is-current-slide"), s.css("transform", "translateX(" + (d ? "" : "-") + 100 * h + "%)"), n(r), clearTimeout(p), t.preventDefault() }), f.find(".toggle").click(function() { s.css("transform", "translateX(" + (d ? "" : "-") + 100 * (h - 1) + "%)"), i(r), p = setTimeout(function() { r.removeClass("is-current-slide"), l.removeClass("is-current-parent") }, 300), a.removeClass("active"), a.attr("aria-expanded", "false") })
                })
            })
        }
    })

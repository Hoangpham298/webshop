...
<header class="top-navbar">
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            ...
            <div class="collapse navbar-collapse bg-white" id="navbars-rs-food">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdown-a">
                            <a class="dropdown-item" href="reservation.php">Thông tin bàn</a>
                            <a class="dropdown-item" href="stuff.php">Đầu bếp</a>
                            <a class="dropdown-item" href="gallery.php">Ảnh mẫu</a>
                        </div>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdown-a">
                            ...
                            <a class="dropdown-item" href="blog-details.php">Thông tin Blog</a>
                        </div>
                    </li>

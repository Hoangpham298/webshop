...
Grav needs your webserver to be able to write to certain directories.  Make sure that `backup/`, `cache/`, `/`, `logs/`, and `tmp/` are all writeable by the user account under which your webserver runs.
